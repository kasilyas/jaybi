...
export const OrderSummaryModal: React.FC<OrderSummaryModalProps> = ({ 
  ...
  return (
    <div className={`fixed inset-0 z-[1100] flex items-center justify-center p-4 sm:p-6 ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <div className="relative w-full max-w-2xl bg-white border border-slate-200 rounded-[3rem] shadow-4xl flex flex-col max-h-[90vh] animate-in zoom-in-95 overflow-hidden modal-fullscreen-mobile">
        
        <header className="p-5 sm:p-8 border-b border-slate-100 shrink-0">
